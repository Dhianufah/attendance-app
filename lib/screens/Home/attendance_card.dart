...
import 'package:attendance_app/screens/Home/widget/photo_viewer.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

class AttendanceCard extends StatelessWidget {
  final AttenndanceRecord? todayRecord;
  ...
  Widget build(BuildContext context) {
    ...
    final (cardColor, iconColor, iconData, statusText) = _getCardStyle(
    ...
    // ini buat ngisi color di setiap stepnya
  ...
  Widget _buildTimeDetails(Color color) {
    return Container(
      ...
      child: Column(
        children: [
          _TimeRow(
            // ini tuh kode buat yang bagian kalo misalnya udh ada foto trs kek waktu laporan nya gitu 
